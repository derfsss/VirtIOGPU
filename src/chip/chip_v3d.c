                              ...
                              struct V3DContextInfo *info)
{
    ...
    info->fs_repfog_handle   = gs->virgl_2d_fs_repfog;
    info->vs_mtex_handle     = gs->virgl_2d_vs_mtex;
    info->fs_mtex_mod_handle = gs->virgl_2d_fs_mtex_mod;
    info->ve_mtex_handle     = gs->virgl_2d_ve_mtex;
