...
struct ChipGPUState {
    ...
    struct MsgPort *gpu_srv_hi;         /* high-pri reqs (present/cursor)  */
    struct MsgPort *gpu_srv_lo;         /* low-pri reqs (bulk 3D draws)    */
    volatile BOOL   gpu_srv_running;    /* set TRUE once both ports ready  */
